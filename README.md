# Query11 - Análise Completa de Vulnerabilidades do chromium

## Descrição

A **Query11** é um script Python que combina as funcionalidades das queries 7 e 10 para realizar uma análise abrangente das vulnerabilidades do projeto **chromium**, integrando dados de documentação com informações detalhadas dos commits do GitHub.
...
- **Filtro**: Apenas projeto chromium
...
| Coluna | Descrição |
|--------|-----------|
| Projeto | Nome do projeto (chromium) |
...
2. **Filtra vulnerabilidades** do chromium
...
- ✅ **Análise focada** no projeto chromium
